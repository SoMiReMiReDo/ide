...
def search_weather():
    print("def search_weather():")
    form = WeatherForm()
    if form.validate_on_submit():
        try:
            # todo
            #     File "D:/PyClass/homework/LearnPythontheHardWay-master/extended/Chap3/project/weather_app.py", line 39, in search_weather
